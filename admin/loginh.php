...
<body class="imgloaded">
          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        <a href="index" class="p-3 text-decoration-none text-light bold">
    ...
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div class="container">
            <div class="row">
                <div class="col-xl-8">
                    <h1 class="display-1 bold color_white content__title">
                        HACKLAB CTF<span class="vim-caret">&nbsp;</span></h1>
                ...
                <div class="input-field">
                    <input type="submit"  value="Login" class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" name="button" style=" cursor:pointer;">
                </div>
            </div>
        </form>
        </div>
...
if (isset($_POST['button'])) {
    ...
    if ($rowCount_check_fid == 0) {
        echo '<div class="alert2 alert-danger" style="border: 1px solid transparent; background-color: transparent; color: red; font-size: 20px;" role="alert">Wrong Credenctials</div>';
    } else if ($rowCount_check_team == 0) {
    ...
    } else if ($rowCount_check_password == 0) {
        echo '<div class="alert2 alert-danger" style="border: 1px solid transparent; background-color: transparent; color: red; font-size: 20px;" role="alert">Wrong Credentials</div>';
    } else {
        ...
        if (isset($_SESSION['user_name']) && $_SESSION['user_name'] == $_POST["team_name"]) {
            ...
            if ($row) {
                ...
                ?>
                    <meta http-equiv = "refresh" content = "0; url = password"/>
                    <?php
                }
            }
        }
