...
if ($conn) {
    ...
    $fetch_team_names_query = "SELECT DISTINCT team_name FROM login";
$result_team_names = mysqli_query($conn, $fetch_team_names_query);

// Iterate through fetched team names and insert into scoreboard if not already present
while ($row_team_name = mysqli_fetch_assoc($result_team_names)) {
    $team_name = $row_team_name['team_name'];

    // Check if team_name already exists in scoreboard table
    $check_query = "SELECT * FROM scoreboard WHERE team_name = ?";
    ...
    if ($result_check->num_rows == 0) {
        ...
        $insert_query = "INSERT INTO scoreboard (team_name) VALUES (?)";
          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="Scoreboard" class="p-3 text-decoration-none text-white bold">
...
<body>
  ...
  var countDownDate = new Date('Oct 30, 2024 17:45:00 GMT+0530');
  ...
  function updateCountdown() {
    ...
    if (distance <= 0) {
      window.location.href = 'scoreboard1';
    } else {
 ...
 <!-- <script>
    function updateClock() {
        ...
        if (hours == 17 && minutes == 30 && seconds == 0) {
