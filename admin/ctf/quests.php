...
<body style="
background-image: url('../uploads/quests-bg.jpg');
...
">    
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="min-width: 100px;">
    <a href="profile" class="dropdown-item" style="color: white;font-weight: bold;"><i class="fas fa-user mr-2"></i> Profile</a>
...
<?php include 'challenge_template.php'; ?>
            ...
            <div class="row hackerFont justify-content-center mt-5">
                <div class="col-md-12">
                    ...
                    <span class="p-1" style="background-color:#808080">operating</span>
                </div>
            </div>
        </div>
