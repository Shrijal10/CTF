...
if ($login_image_result['success']) {
    echo "Login Image uploaded successfully: " . htmlspecialchars($login_image_result['file_path']);
} else {
    echo "Login Image upload failed: " . htmlspecialchars($login_image_result['message']);
}
