...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Default query to show latest name
    $ctf_query = "SELECT names FROM ctf_names ORDER BY id DESC LIMIT 1";
}
...
if ($ctf_run->num_rows > 0) {
    ...
    echo '<script>alert("CTF_names are not present."); location.href="index1.php";</script>';
}
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
              <?php
                $query = "SELECT COUNT(*) as total FROM ctf .challenges";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
              <?php
                $query = "SELECT COUNT(*) as total FROM ctf.login";
                $result = mysqli_query($con, $query);
                $row = mysqli_fetch_assoc($result);
                ?>
                <h3><?php echo $row['total']; ?></h3>
