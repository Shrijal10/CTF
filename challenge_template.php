    ...
    function closePopup3() {
        ...
        popup.style.display = "none";
                    ...
                    document.getElementById("readmore2").onclick = function() {
                        ...
                        popup.document.write("<p>This password is the password of the admin of the HackLab CTF server.<br>Please use this password with caution2.</p>");
    ...
    function closePopup4() {
        ...
        popup.style.display = "none";
                    ...
                    document.getElementById("readmore3").onclick = function() {
                        var popup = window.open('','popUpWindow', 'height=500,width=500,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=yes');
                        popup.document.write("<p>This password is the password of the admin of the HackLab CTF server.<br>Please use this password with caution3.</p>");
                        popup.document.close();
                    };
                </script>
                                <form action="" method="POST" autocomplete="off">
